...
final class Projectile extends Renderable {
	...
	public Projectile(int spotanim, int target, int sourceX, int sourceY, int sourceZ, int level, int firstTick, int lastTick, int arcScale, int elevationPitch, int baseZ) {
