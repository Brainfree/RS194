...
public class LocationInfo {
	...
	public static LinkedList models = new LinkedList(500);
	public static LinkedList builtModels = new LinkedList(30);
		...
		if (modelTypes == null) {
			...
			for (int n = 0; n < modelCount; n++) {
				...
				if (m == null) {
					...
					// reasons minDepth would be null at this point:
					//
