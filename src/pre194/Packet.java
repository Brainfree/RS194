...
public class Packet {
	...
	public static final int UPDATE_SCENE = 47;
	...
	public static final int FOURTH_OBJECT_ACTION = 65;
	...
	public static final int SECTOR_CHANGE_RESPONSE = 117;
	...
	public static final int IDLE = 135;
	public static final int SET_VIEWPORT_AND_SIDEBAR_WIDGETS = 138;
	public static final int WALK = 147;
	...
	public static final int FIFTH_OBJECT_ACTION = 216;
	public static final int SET_MULTIZONE = 217;
	public static final int SET_CHAT_SETTINGS = 220;
	public static final int FIRST_OBJECT_ACTION = 221;
	public static final int HEARTBEAT = 223;
	...
	public static final int SECTOR_CHANGE = 232;
	public static final int SECOND_OBJECT_ACTION = 233;
	...
	public static final int THIRD_OBJECT_ACTION = 249;
	public static final int REMOVE_OBJECT_STACK = 250;
	public static final int SET_SELECTED_TAB = 254;

	private static final Map<Integer, String> packetNames = new HashMap<>();

	public static final String getName(int type) {
		if (!packetNames.containsKey(type)) {
			return "Unknown packet: " + type;
		}
		return packetNames.get(type);
	}
		...
		for (Field f : Packet.class.getDeclaredFields()) {
			try {
				if (f.getType() == int.class) {
					packetNames.put(f.getInt(null), f.getName());
				}
			} catch (Exception e) {
				e.printStackTrace();
			}
